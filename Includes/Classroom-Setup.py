...
# MAGIC %fs rm -r /adsda/ht-users-athletes

# COMMAND ----------

# MAGIC %fs rm -r /adsda/ht-users-non-athletes

# COMMAND ----------

# MAGIC %fs rm -r /adsda/ht-device-metrics

# COMMAND ----------

# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS adsda.ht_users_athletes;
# MAGIC DROP TABLE IF EXISTS adsda.ht_users_non_athletes;
# MAGIC DROP TABLE IF EXISTS adsda.ht_device_metrics;